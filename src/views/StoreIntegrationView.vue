...
<template>
  <div class="flex flex-column gap-4 container-store justify-content-start align-items-start">
      ...
      <template #content>
        <div class="flex flex-col gap-4">
          <p class="text-gray-500">
            Guarda tus archivos en un almacenamiento accesible para que el asistente pueda acceder a
            ellos.
          </p>
        </div>
      </template>
